<script lang="ts">
	...
	import { Query_userTest1ConnectionStore, Mutation_userTest1_updateStore } from '$houdini';
	import type { PageData } from './$houdini';

	export let data: PageData;
	$: Query_userTest1Connection = data.Query_userTest1Connection as Query_userTest1ConnectionStore;
	const Mutation_userTest1_update = new Mutation_userTest1_updateStore();
	...
	const mutation = (
		...
		Mutation_userTest1_update.mutate(event.detail.args)
			.then((result) => {
