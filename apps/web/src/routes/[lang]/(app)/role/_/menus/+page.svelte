<script lang="ts">
	...
	import MenuCreateTable from '~/lib/components/objects/menu/MenuCreateTable.svelte';
	...
	$: nodes = data.nodes as (MutationTypeMenuArgs | null | undefined)[];
	...
	const mutation = (event: CustomEvent<{ nodes: (MutationTypeMenuArgs | null | undefined)[] | null | undefined}> ) => {
		nodes = [...event.detail.nodes || []];
	};

	const save = (event: CustomEvent<{ nodes: (MutationTypeMenuArgs | null | undefined)[] | null | undefined}> ) => {
		ot({
