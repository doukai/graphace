<script lang="ts">
	...
	import { Mutation_user_userRoleStore } from '$houdini';
	...
	$: urlName($page.url, $LL.graphql.objects.User.fields.userRole.name(), PageType.CREATE);
	...
	const mutation = (
		...
		validateMutation('User', { id: id, userRole: [event.detail.args] }, true, $locale)
			.then((data) => {
				errors = {};
