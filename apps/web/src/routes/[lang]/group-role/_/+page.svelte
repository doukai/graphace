<script lang="ts">
	...
	$: urlName($page.url, $LL.graphql.objects.GroupRole.name(), PageType.CREATE);
...
<GroupRoleCreateForm showRemoveButton={false} showBackButton={$canBack} {node} {errors} on:mutation={mutation} on:back={back} on:gotoField={gotoField} />
