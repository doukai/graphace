<script lang="ts">
	...
	$: urlName($page.url, $LL.graphql.objects.UserRole.name(), PageType.CREATE);
...
<UserRoleCreateForm showRemoveButton={false} showBackButton={$canBack} {node} {errors} on:mutation={mutation} on:back={back} on:gotoField={gotoField} />
