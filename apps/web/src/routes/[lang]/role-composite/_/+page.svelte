<script lang="ts">
	...
	import { Mutation_roleCompositeStore } from '$houdini';
...
<RoleCompositeCreateForm showRemoveButton={false} showBackButton={$canBack} {node} {errors} on:mutation={mutation} on:back={back} on:gotoField={gotoField} />
