<script lang="ts">
	...
	import {
		...
		Operator,
		UserTest2Edge,
		UserTest2EdgeOrderBy,
		QueryTypeUserTest2EdgeListArgs,
		MutationTypeUserTest2EdgeArgs
	} from '~/gql/generated/schema';

	export let nodes: (UserTest2Edge | null | undefined)[] | null | undefined;
	export let totalCount: number = 0;
	export let isFetching: boolean;

	const dispatch = createEventDispatcher<{
		fetch: {
			args: QueryTypeUserTest2EdgeListArgs;
			then: (data: (UserTest2Edge | null | undefined)[] | null | undefined) => void;
			catch: (error: Error) => void;
		};
		mutation: {
			args: MutationTypeUserTest2EdgeArgs;
			then: (data: UserTest2Edge | null | undefined) => void;
			catch: (error: Error) => void;
		};
	}>();
	...
	let args: QueryTypeUserTest2EdgeListArgs = {};
	let orderBy: UserTest2EdgeOrderBy = {};
	...
	async function updateField(args: MutationTypeUserTest2EdgeArgs | null | undefined) {
		if (args && args.id) {
			errors[args.id] = {};
			validateUpdate('UserTest2Edge', args, $locale)
				.then((data) => {
					if (args) {
						dispatch('mutation', {
							args,
...
<SectionHead title="UserTest2Edge">
