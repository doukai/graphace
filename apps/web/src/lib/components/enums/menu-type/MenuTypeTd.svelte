<script lang="ts">
	...
	import { MenuType } from '~/lib/types/schema';
	...
	$: enums = [
		{ name: $LL.graphql.enums.MenuType.values.FOLDER.name(), value: 'FOLDER' },
		{ name: $LL.graphql.enums.MenuType.values.PAGE.name(), value: 'PAGE' }
	];
</script>
