<script lang="ts">
	...
	import {
		...
		Operator,
		UserTest1Edge,
		UserTest1EdgeOrderBy,
		QueryTypeUserTest1EdgeListArgs,
		MutationTypeUserTest1EdgeArgs
	} from '~/gql/generated/schema';

	export let nodes: (UserTest1Edge | null | undefined)[] | null | undefined;
	export let totalCount: number = 0;
	export let isFetching: boolean;

	const dispatch = createEventDispatcher<{
		fetch: {
			args: QueryTypeUserTest1EdgeListArgs;
			then: (data: (UserTest1Edge | null | undefined)[] | null | undefined) => void;
			catch: (error: Error) => void;
		};
		mutation: {
			args: MutationTypeUserTest1EdgeArgs;
			then: (data: UserTest1Edge | null | undefined) => void;
			catch: (error: Error) => void;
		};
	}>();
	...
	let args: QueryTypeUserTest1EdgeListArgs = {};
	let orderBy: UserTest1EdgeOrderBy = {};
	...
	async function updateField(args: MutationTypeUserTest1EdgeArgs | null | undefined) {
		if (args && args.id) {
			errors[args.id] = {};
			validateUpdate('UserTest1Edge', args, $locale)
				.then((data) => {
					if (args) {
						dispatch('mutation', {
							args,
...
<SectionHead title="UserTest1Edge">
