...
<Card>
	...
	>
		...
		<ObjectItem name="from" path="_/from" label={$LL.graphql.objects.RoleComposite.fields.from.name()} errors={errors.from} on:gotoField />
		...
		<ObjectItem name="to" path="_/to" label={$LL.graphql.objects.RoleComposite.fields.to.name()} errors={errors.to} on:gotoField />
