<script lang="ts">
	...
	import type { MutationTypeSubscriptionTypeArgs } from '~/lib/types/schema';

	export let nodes: (MutationTypeSubscriptionTypeArgs | null | undefined)[] | null | undefined;
	export let errors: Record<number, Errors> = {};

	const dispatch = createEventDispatcher<{
		edit: { row: number };
		create: {};
		save: { nodes: (MutationTypeSubscriptionTypeArgs | null | undefined)[] | null | undefined };
		back: {};
	}>();
