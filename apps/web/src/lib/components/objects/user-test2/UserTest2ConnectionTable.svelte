<script lang="ts">
	...
	import {
		...
		UserTest2,
		UserTest2OrderBy,
		QueryTypeUserTest2ConnectionArgs,
		MutationTypeUserTest2Args
	} from '~/lib/types/schema';

	export let nodes: (UserTest2 | null | undefined)[] | null | undefined;
	...
	const dispatch = createEventDispatcher<{
		...
		edit: { id: string };
		create: {};
		save: { nodes: (UserTest2 | null | undefined)[] | null | undefined };
		back: {};
	}>();
	...
	let args: QueryTypeUserTest2ConnectionArgs = {};
	let orderBy: UserTest2OrderBy = {};
	...
	async function updateField(args: MutationTypeUserTest2Args | null | undefined) {
		if (args && args.id) {
			errors[args.id] = {};
			validateUpdate('UserTest2', args, $locale)
				.then((data) => {
					if (args) {
						dispatch('mutation', {
							args,
