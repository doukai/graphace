<script lang="ts">
	...
	import ApiTypeInput from '~/lib/components/enums/api-type/ApiTypeInput.svelte';
	import type { StringExpression } from '@graphace/graphql/types';
	import LL from '$i18n/i18n-svelte';
	import type { ApiTypeExpression, ApiExpression } from '$houdini';

	export let name: string;
	export let expression: ApiExpression | null | undefined;
		...
		<div class="grid grid-cols-2 gap-2">
			<div class="join">
				<button class="btn btn-active btn-ghost join-item w-1/3">
					{$LL.graphql.objects.Api.fields.name.name()}
				</button>
				<select
			...
			<div class="join">
				<button class="btn btn-active btn-ghost join-item w-1/3">
					{$LL.graphql.objects.Api.fields.description.name()}
				</button>
				<select
					class="select select-bordered join-item w-2/3"
			...
			<div class="join">
				<button class="btn btn-active btn-ghost join-item w-1/3">
					{$LL.graphql.objects.Api.fields.type.name()}
				</button>
				<select
					class="select select-bordered join-item w-2/3"
