<script lang="ts">
	...
	export let nodes: (MutationTypeApiArgs | null | undefined)[] | null | undefined;
	...
	const dispatch = createEventDispatcher<{
		edit: { row: number };
		create: {};
		mutation: { nodes: (MutationTypeApiArgs | null | undefined)[] | null | undefined };
		save: { nodes: (MutationTypeApiArgs | null | undefined)[] | null | undefined };
		gotoSelect: {};
		back: {};
	}>();
	...
	<Table>
		<thead>
			<tr>
				...
				<td>{$LL.graphql.objects.Api.fields.name.name()}</td>
				<td>{$LL.graphql.objects.Api.fields.description.name()}</td>
				<td>{$LL.graphql.objects.Api.fields.type.name()}</td>
				<td>{$LL.graphql.objects.Api.fields.role.name()}</td>
				<td>{$LL.graphql.objects.Api.fields.realm.name()}</td>
				<th />
			</tr>
		</thead>
		<tbody>
