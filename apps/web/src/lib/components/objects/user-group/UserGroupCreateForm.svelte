<script lang="ts">
	...
	const dispatch = createEventDispatcher<{
		mutation: { node: MutationTypeUserGroupArgs| null | undefined };
		save: { node: MutationTypeUserGroupArgs| null | undefined };
		gotoSelect: {};
		back: {};
	}>();
...
<Card>
	...
	>
		...
		<IntItem label="groupId" name="groupId" bind:value={node.groupId} errors={errors.groupId} />
