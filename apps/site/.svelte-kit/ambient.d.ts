...
declare module '$env/static/private' {
	...
	export const LIBMYSQL_PLUGIN_DIR: string;
	...
	export const npm_package_dependencies__packages_components: string;
	export const npm_package_dependencies__packages_components_graphql: string;
	export const npm_package_dependencies__packages_graphql: string;
	...
	export const npm_package_scripts_vite: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies__packages_components: string;
		npm_package_dependencies__packages_components_graphql: string;
		npm_package_dependencies__packages_graphql: string;
		...
		npm_package_scripts_vite: string;
