<script lang="ts">
	...
	$: selectOptions = [
		...
		},
		{
			...
			options: [
				...
				{
					value: 'isDeprecated',
					label: $LL.graphql.objects.Group.fields.parent.name() + $LL.graphql.objects.Group.fields.isDeprecated.name(),
					disabled: !permissions.auth('Group::isDeprecated::READ')
				},
				{
					value: 'version',
					label: $LL.graphql.objects.Group.fields.parent.name() + $LL.graphql.objects.Group.fields.version.name(),
					disabled: !permissions.auth('Group::version::READ')
				},
				{
					value: 'realmId',
					label: $LL.graphql.objects.Group.fields.parent.name() + $LL.graphql.objects.Group.fields.realmId.name(),
					disabled: !permissions.auth('Group::realmId::READ')
				},
				{
					value: 'createUserId',
					label: $LL.graphql.objects.Group.fields.parent.name() + $LL.graphql.objects.Group.fields.createUserId.name(),
					disabled: !permissions.auth('Group::createUserId::READ')
				},
				{
					value: 'createTime',
					label: $LL.graphql.objects.Group.fields.parent.name() + $LL.graphql.objects.Group.fields.createTime.name(),
					disabled: !permissions.auth('Group::createTime::READ')
				},
				{
					value: 'updateUserId',
					label: $LL.graphql.objects.Group.fields.parent.name() + $LL.graphql.objects.Group.fields.updateUserId.name(),
					disabled: !permissions.auth('Group::updateUserId::READ')
				},
				{
					value: 'updateTime',
					label: $LL.graphql.objects.Group.fields.parent.name() + $LL.graphql.objects.Group.fields.updateTime.name(),
					disabled: !permissions.auth('Group::updateTime::READ')
				},
				{
					value: 'createGroupId',
					label: $LL.graphql.objects.Group.fields.parent.name() + $LL.graphql.objects.Group.fields.createGroupId.name(),
					disabled: !permissions.auth('Group::createGroupId::READ')
				},
				{
					value: 'syncGroupPolicy',
					label: $LL.graphql.objects.Group.fields.parent.name() + $LL.graphql.objects.Group.fields.syncGroupPolicy.name(),
		...
		},
		{
			...
			options: [
				...
				{
					value: 'isDeprecated',
					label: $LL.graphql.objects.Group.fields.realm.name() + $LL.graphql.objects.Realm.fields.isDeprecated.name(),
					disabled: !permissions.auth('Realm::isDeprecated::READ')
				},
				{
					value: 'version',
					label: $LL.graphql.objects.Group.fields.realm.name() + $LL.graphql.objects.Realm.fields.version.name(),
					disabled: !permissions.auth('Realm::version::READ')
				},
				{
					value: 'realmId',
					label: $LL.graphql.objects.Group.fields.realm.name() + $LL.graphql.objects.Realm.fields.realmId.name(),
					disabled: !permissions.auth('Realm::realmId::READ')
				},
				{
					value: 'createUserId',
					label: $LL.graphql.objects.Group.fields.realm.name() + $LL.graphql.objects.Realm.fields.createUserId.name(),
					disabled: !permissions.auth('Realm::createUserId::READ')
				},
				{
					value: 'createTime',
					label: $LL.graphql.objects.Group.fields.realm.name() + $LL.graphql.objects.Realm.fields.createTime.name(),
					disabled: !permissions.auth('Realm::createTime::READ')
				},
				{
					value: 'updateUserId',
					label: $LL.graphql.objects.Group.fields.realm.name() + $LL.graphql.objects.Realm.fields.updateUserId.name(),
					disabled: !permissions.auth('Realm::updateUserId::READ')
				},
				{
					value: 'updateTime',
					label: $LL.graphql.objects.Group.fields.realm.name() + $LL.graphql.objects.Realm.fields.updateTime.name(),
					disabled: !permissions.auth('Realm::updateTime::READ')
				},
				{
					value: 'createGroupId',
					label: $LL.graphql.objects.Group.fields.realm.name() + $LL.graphql.objects.Realm.fields.createGroupId.name(),
	...
	$: joinOptions = [
		{
			...
			options: [
				...
				{
					value: 'isDeprecated',
					label: $LL.graphql.objects.Group.fields.subGroups.name() + $LL.graphql.objects.Group.fields.isDeprecated.name(),
					disabled: !permissions.auth('Group::isDeprecated::READ')
				},
				{
					value: 'version',
					label: $LL.graphql.objects.Group.fields.subGroups.name() + $LL.graphql.objects.Group.fields.version.name(),
					disabled: !permissions.auth('Group::version::READ')
				},
				{
					value: 'realmId',
					label: $LL.graphql.objects.Group.fields.subGroups.name() + $LL.graphql.objects.Group.fields.realmId.name(),
					disabled: !permissions.auth('Group::realmId::READ')
				},
				{
					value: 'createUserId',
					label: $LL.graphql.objects.Group.fields.subGroups.name() + $LL.graphql.objects.Group.fields.createUserId.name(),
					disabled: !permissions.auth('Group::createUserId::READ')
				},
				{
					value: 'createTime',
					label: $LL.graphql.objects.Group.fields.subGroups.name() + $LL.graphql.objects.Group.fields.createTime.name(),
					disabled: !permissions.auth('Group::createTime::READ')
				},
				{
					value: 'updateUserId',
					label: $LL.graphql.objects.Group.fields.subGroups.name() + $LL.graphql.objects.Group.fields.updateUserId.name(),
					disabled: !permissions.auth('Group::updateUserId::READ')
				},
				{
					value: 'updateTime',
					label: $LL.graphql.objects.Group.fields.subGroups.name() + $LL.graphql.objects.Group.fields.updateTime.name(),
					disabled: !permissions.auth('Group::updateTime::READ')
				},
				{
					value: 'createGroupId',
					label: $LL.graphql.objects.Group.fields.subGroups.name() + $LL.graphql.objects.Group.fields.createGroupId.name(),
					disabled: !permissions.auth('Group::createGroupId::READ')
				},
				{
					value: 'syncGroupPolicy',
					label: $LL.graphql.objects.Group.fields.subGroups.name() + $LL.graphql.objects.Group.fields.syncGroupPolicy.name(),
					disabled: !permissions.auth('Group::syncGroupPolicy::READ')
				}
			],
		...
		},
		{
			...
			options: [
				...
				},
				{
					...
					disabled: !permissions.auth('User::isDeprecated::READ')
				},
				{
					value: 'version',
					label: $LL.graphql.objects.Group.fields.users.name() + $LL.graphql.objects.User.fields.version.name(),
					disabled: !permissions.auth('User::version::READ')
				},
				{
					value: 'realmId',
					label: $LL.graphql.objects.Group.fields.users.name() + $LL.graphql.objects.User.fields.realmId.name(),
					disabled: !permissions.auth('User::realmId::READ')
				},
				{
					value: 'createUserId',
					label: $LL.graphql.objects.Group.fields.users.name() + $LL.graphql.objects.User.fields.createUserId.name(),
					disabled: !permissions.auth('User::createUserId::READ')
				},
				{
					value: 'createTime',
					label: $LL.graphql.objects.Group.fields.users.name() + $LL.graphql.objects.User.fields.createTime.name(),
					disabled: !permissions.auth('User::createTime::READ')
				},
				{
					value: 'updateUserId',
					label: $LL.graphql.objects.Group.fields.users.name() + $LL.graphql.objects.User.fields.updateUserId.name(),
					disabled: !permissions.auth('User::updateUserId::READ')
				},
				{
					value: 'updateTime',
					label: $LL.graphql.objects.Group.fields.users.name() + $LL.graphql.objects.User.fields.updateTime.name(),
					disabled: !permissions.auth('User::updateTime::READ')
				},
				{
					value: 'createGroupId',
					label: $LL.graphql.objects.Group.fields.users.name() + $LL.graphql.objects.User.fields.createGroupId.name(),
					disabled: !permissions.auth('User::createGroupId::READ')
				},
				{
		...
		},
		{
			...
			options: [
				...
				{
					value: 'isDeprecated',
					label: $LL.graphql.objects.Group.fields.roles.name() + $LL.graphql.objects.Role.fields.isDeprecated.name(),
					disabled: !permissions.auth('Role::isDeprecated::READ')
				},
				{
					value: 'version',
					label: $LL.graphql.objects.Group.fields.roles.name() + $LL.graphql.objects.Role.fields.version.name(),
					disabled: !permissions.auth('Role::version::READ')
				},
				{
					value: 'realmId',
					label: $LL.graphql.objects.Group.fields.roles.name() + $LL.graphql.objects.Role.fields.realmId.name(),
					disabled: !permissions.auth('Role::realmId::READ')
				},
				{
					value: 'createUserId',
					label: $LL.graphql.objects.Group.fields.roles.name() + $LL.graphql.objects.Role.fields.createUserId.name(),
					disabled: !permissions.auth('Role::createUserId::READ')
				},
				{
					value: 'createTime',
					label: $LL.graphql.objects.Group.fields.roles.name() + $LL.graphql.objects.Role.fields.createTime.name(),
					disabled: !permissions.auth('Role::createTime::READ')
				},
				{
					value: 'updateUserId',
					label: $LL.graphql.objects.Group.fields.roles.name() + $LL.graphql.objects.Role.fields.updateUserId.name(),
					disabled: !permissions.auth('Role::updateUserId::READ')
				},
				{
					value: 'updateTime',
					label: $LL.graphql.objects.Group.fields.roles.name() + $LL.graphql.objects.Role.fields.updateTime.name(),
					disabled: !permissions.auth('Role::updateTime::READ')
				},
				{
					value: 'createGroupId',
					label: $LL.graphql.objects.Group.fields.roles.name() + $LL.graphql.objects.Role.fields.createGroupId.name(),
	...
	export const buildArguments = (): QueryGroupListArgs => {
