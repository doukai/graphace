		...
		},
		{
			...
			options: [
				...
				},
				{
					...
					disabled: !permissions.auth('Group::descriptionCount::READ')
				},
				{
					...
					disabled: !permissions.auth('Group::descriptionMax::READ')
				},
				{
