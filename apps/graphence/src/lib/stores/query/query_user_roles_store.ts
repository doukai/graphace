...
export async function fetchQuery_user_roles_Store(event: LoadEvent | RequestEvent, variables: { user_id: string } & QueryRoleConnectionArgs): Promise<Query_user_roles_Store> {
