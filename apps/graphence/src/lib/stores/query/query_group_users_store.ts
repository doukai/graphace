...
export async function fetchQuery_group_users_Store(event: LoadEvent | RequestEvent, variables: { group_id: string } & QueryUserConnectionArgs): Promise<Query_group_users_Store> {
