...
export async function fetchQuery_role_users_Store(event: LoadEvent | RequestEvent, variables: { role_id: string } & QueryUserConnectionArgs): Promise<Query_role_users_Store> {
