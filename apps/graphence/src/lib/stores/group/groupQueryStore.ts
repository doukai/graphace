...
export async function createGroupConnectionQueryStore(params: { event: LoadEvent, fields: Field[], queryArguments: GroupConnectionQueryArguments }): Promise<GroupConnectionQueryStore> {
    ...
    const fetch = async (fields: Field[], queryArguments: GroupConnectionQueryArguments, directives?: Directive[]) => {
...
export type GroupConnectionQueryStore = {
    ...
    fetch: (fields: Field[], queryArguments: GroupConnectionQueryArguments, directives?: Directive[]) => Promise<{ data?: { groupConnection: GroupConnection | null | undefined }, errors?: GraphQLError[] | null | undefined }>;
}