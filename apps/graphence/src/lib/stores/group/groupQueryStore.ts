...
export async function createGroupConnectionQueryStore(params: { event: LoadEvent, fields: Field[], queryArguments: GroupConnectionQueryArguments }): Promise<GroupConnectionQueryStore> {
    ...
    const fetch = async (fields: Field[], queryArguments: GroupConnectionQueryArguments, directives?: string[]) => {
...
export type GroupConnectionQueryStore = {
    ...
    fetch: (fields: Field[], queryArguments: GroupConnectionQueryArguments, directives?: string[]) => Promise<{ data?: { groupConnection: GroupConnection | null | undefined }, errors?: GraphQLError[] | null | undefined }>;
}