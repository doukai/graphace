...
export async function createRoleListMutationStore(params: { event: LoadEvent }): Promise<RoleListMutationStore> {
    ...
    const fetch = async (fields: Field[], mutationArguments: RoleListMutationArguments, directives?: string[]) => {
...
export type RoleListMutationStore = {
    ...
    fetch: (fields: Field[], mutationArguments: RoleListMutationArguments, directives?: string[]) => Promise<{ data?: { roleList: Role[] | null | undefined }, errors?: GraphQLError[] | null | undefined } | null | undefined>;
}