...
const query = ({ directives }: QueryParams) =>/* GraphQL */ `mutation Mutation_permissionList($id: ID, $name: String, $description: String, $field: String, $type: String, $permissionType: PermissionType, $roles: [RoleInput], $realm: RealmInput, $isDeprecated: Boolean, $version: Int, $realmId: Int, $createUserId: String, $createTime: Timestamp, $updateUserId: String, $updateTime: Timestamp, $createGroupId: String, $rolePermissionRelation: [RolePermissionRelationInput], $list: [PermissionInput], $where: PermissionExpression) {
