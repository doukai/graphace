import { Errors, Error } from "../index.js";

export function buildErrorsTree(path: string[], data: Record<string, any>, errors: Error[], errorsTree: Record<string, Errors>): Record<string, Errors> {
