<script lang="ts">
	import { typeEditorModals } from './TypeEditorModals.svelte';
	import { listTypeEditorModals } from './ListTypeEditorModals.svelte';
	import { TypeManager } from '@packages/graphql/request/Type';
	import { getType } from '$lib/graphql/Introspection';
	import type { __Type, __Field } from '@packages/graphql';
