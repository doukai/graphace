<script lang="ts">
	...
	import { queryType, mutationType, removeType } from '@packages/graphql/request/Type';
	import { TypeManager } from '@packages/graphql';
	import { type __Type, type Error, __TypeKind } from '@packages/graphql';
	import { Form, FormLoading, FormItems, FormItem, FormButtons } from '@packages/components';
	import ObjectEditButton from './ObjectEditButton.svelte';
	import FieldInput from './FieldInput.svelte';
	import { messageBoxs } from '@packages/components';
